  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'colored': '0 4px 25px -5px rgba(59, 130, 246, 0.15)',
        'colored-lg': '0 10px 50px -12px rgba(59, 130, 246, 0.25)',
        'green': '0 4px 25px -5px rgba(16, 185, 129, 0.15)',
        'purple': '0 4px 25px -5px rgba(139, 92, 246, 0.15)',
        'orange': '0 4px 25px -5px rgba(245, 158, 11, 0.15)',
      }
    },
  },
  plugins: [
    // Les plugins Tailwind seront ajoutés après installation
