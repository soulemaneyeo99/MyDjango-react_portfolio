      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden relative w-12 h-12 border border-white/10 flex flex-col items-center justify-center space-y-1.5 z-[101] active:scale-95 transition-transform"
